...
export default async function handler(
  ...
  if (req.method === 'POST') {
    ...
    try {
      // Construir el objeto where dinámicamente con el tipo Prisma.PedidoWhereInput
      const whereConditions: Prisma.PedidoWhereInput = {
        createdAt: {
          gte: startDate,
          lte: endDate,
        },
        ...
        // Agregar condición de familia si se proporciona
        ...(familia && {
          items: {
            some: {
              OR: [
